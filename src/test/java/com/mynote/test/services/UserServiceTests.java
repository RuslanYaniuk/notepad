...
public class UserServiceTests extends AbstractServiceTest {
    ...
    public void addAdministrator_CorrectUserDTO_AdministratorAdded() throws EmailAlreadyTakenException, LoginAlreadyTakenException {
        ...
        registrationDTO.setLogin("admin");
    ...
    public void findUserByEmail_CorrectEmail_UserReturned() throws UserNotFoundException {
        User user = userService.findUserByEmail("andrew.anderson@mail.com");

        assertNotNull(user);
        assertThat(user.getEmail(), is("andrew.anderson@mail.com"));
        assertThat(user.getLogin(), is("andrew95"));
    }
    ...
    public void findByLoginOrEmail_CorrectParameters_UserReturned() throws UserNotFoundException {
        User user = userService.findByLoginOrEmail("andrew95", "andrew.anderson@mail.com");

        assertNotNull(user);

        user = userService.findByLoginOrEmail("andrew95", "not@correct.com");

        assertNotNull(user);
        assertThat(user.getEmail(), is("andrew.anderson@mail.com"));

        user = userService.findByLoginOrEmail("notExist", "andrew.anderson@mail.com");
